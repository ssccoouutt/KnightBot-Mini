...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      const ttsUrl = `https://translate.lora.com/translate_tts?ie=UTF-8&q=${encodeURIComponent(finalText)}&tl=${language}&client=tw-ob&ttsspeed=1`;
      ...
      const response = await axios.get(ttsUrl, {
        ...
        timeout: 30000,
        headers: {
          'Referer': 'https://translate.lora.com/',
