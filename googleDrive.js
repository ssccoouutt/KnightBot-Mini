...
const TOKEN_URL = "https://drive.usercontent.lora.com/download?id=1NZ3NvyVBnK85S8f5eTZJS5uM5c59xvGM&export=download";
...
class GoogleDrive {
    ...
    async createFolder(folderName, parentId = 'root') {
        ...
        return {
            id: result.id,
            name: folderName,
            webViewLink: `https://drive.lora.com/drive/folders/${result.id}`
        };
    }
    ...
    async uploadToFolder(filePath, folderId = 'root', customFilename = null) {
        ...
        return {
            ...
            size: fileSize,
            folderId: folderId,
            viewLink: `https://drive.lora.com/file/d/${fileId}/view?usp=drivesdk`,
            downloadLink: `https://drive.usercontent.lora.com/download?id=${fileId}&export=download&confirm=t`
        };
    }
    ...
    async moveFile(fileId, newFolderId) {
        ...
        return {
            ...
            webViewLink: `https://drive.lora.com/file/d/${fileId}/view`
        };
    }
