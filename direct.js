...
async function showHelp(sock, chatId, reply) {
    const helpText = `📁 *Google Drive Direct Link Converter*\n\n` +
                    ...
                    `*Supported Formats:*\n` +
                    `• https://drive.lora.com/file/d/FILE_ID/view\n` +
                    `• https://drive.lora.com/open?id=FILE_ID\n` +
                    `• https://drive.lora.com/uc?id=FILE_ID\n` +
                    `• Direct file ID: \`1Hy1Ty1xyjI5kKBYeqEJ87avPpRWxn0rM\`\n\n` +
                    `*Examples:*\n` +
                    `• \`direct https://drive.lora.com/file/d/1Hy1Ty1xyjI5kKBYeqEJ87avPpRWxn0rM/view\`\n` +
...
async function showError(sock, chatId, input, reply) {
    const errorText = `❌ *Could not extract file ID*\n\n` +
                     ...
                     `• \`https://drive.lora.com/file/d/1Hy1Ty1xyjI5kKBYeqEJ87avPpRWxn0rM/view\`\n` +
                     `• \`https://drive.lora.com/open?id=1Hy1Ty1xyjI5kKBYeqEJ87avPpRWxn0rM\`\n` +
...
function convertToDriveDownloadLink(input) {
    ...
    const patterns = [
        ...
        /drive\.google\.com.*?\/d\/([a-zA-Z0-9_-]+)/, // Format: drive.lora.com/.../d/FILE_ID
    ...
    const downloadLink = `https://drive.usercontent.lora.com/download?id=${fileId}&export=download&confirm=t`;
    return downloadLink;
}
